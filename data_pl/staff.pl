...
staff('José Sousa', 2, [react, next, program, github_actions]).
...
preference('José Sousa', escape_room_6, 1).
preference('José Sousa', escape_room_7, 1).
...
preference('José Sousa', workshop_react_next_2, 4).

staff('Bruno Oliveira', 3, [teaching, operations, github_actions]).
preference('Bruno Oliveira', coffee_break_1, 3).
preference('Bruno Oliveira', coffee_break_2, 3).
...
preference('Bruno Oliveira', escape_room_6, 2).
preference('Bruno Oliveira', escape_room_7, 2).
...
preference('Beatriz Ferreira', coffee_break_1, 4).
preference('Beatriz Ferreira', coffee_break_2, 4).
...
preference('Beatriz Ferreira', escape_room_6, 4).
preference('Beatriz Ferreira', escape_room_7, 4).
...
staff('Madalena', 4, [react, next, operations, github_actions]).
preference('Madalena', coffee_break_1, 1).
preference('Madalena', coffee_break_2, 1).
preference('Madalena', coffee_break_3, 1).
...
preference('Madalena', escape_room_6, 4).
preference('Madalena', escape_room_7, 4).
...
preference('Madalena', workshop_react_next_2, 3).

staff('Inês Gaspar', 3, [teaching, program, operations]).
preference('Inês Gaspar', coffee_break_1, 5).
preference('Inês Gaspar', coffee_break_2, 5).
preference('Inês Gaspar', coffee_break_3, 5).
...
preference('Inês Gaspar', escape_room_6, 2).
preference('Inês Gaspar', escape_room_7, 2).
...
preference('Inês Gaspar', workshop_react_next_2, 1).

staff('Francisco Cardoso', 1, [next, teaching, program]).
preference('Francisco Cardoso', coffee_break_1, 3).
preference('Francisco Cardoso', coffee_break_2, 3).
...
preference('Francisco Cardoso', escape_room_6, 1).
preference('Francisco Cardoso', escape_room_7, 1).
...
staff('Maria Rita Nogueira Lopes', 5, [react, next, teaching, program, operations, github_actions]).
preference('Maria Rita Nogueira Lopes', coffee_break_1, 5).
preference('Maria Rita Nogueira Lopes', coffee_break_2, 5).
preference('Maria Rita Nogueira Lopes', coffee_break_3, 5).
...
preference('Maria Rita Nogueira Lopes', escape_room_6, 5).
preference('Maria Rita Nogueira Lopes', escape_room_7, 5).
...
preference('Maria Rita Nogueira Lopes', workshop_react_next_2, 5).

staff('José Martins', 2, [react, teaching, operations, github_actions]).
preference('José Martins', coffee_break_1, 1).
preference('José Martins', coffee_break_2, 1).
preference('José Martins', coffee_break_3, 1).
...
preference('José Martins', escape_room_6, 4).
preference('José Martins', escape_room_7, 4).
...
preference('José Martins', workshop_react_next_2, 1).
...
preference('Ruben Esteves', coffee_break_3, 3).
...
preference('Ruben Esteves', escape_room_6, 1).
preference('Ruben Esteves', escape_room_7, 1).
...
preference('Miguel Moita', coffee_break_3, 4).
...
preference('Miguel Moita', escape_room_6, 4).
preference('Miguel Moita', escape_room_7, 4).
...
preference('Rubem Neto', coffee_break_3, 2).
...
preference('Rubem Neto', escape_room_6, 0).
preference('Rubem Neto', escape_room_7, 0).
...
preference('Guilherme Santos', coffee_break_1, 1).
preference('Guilherme Santos', coffee_break_2, 1).
...
preference('Guilherme Santos', escape_room_6, 0).
preference('Guilherme Santos', escape_room_7, 0).
...
staff('João Torre Pereira', 4, [program, operations, github_actions]).
preference('João Torre Pereira', coffee_break_1, 5).
preference('João Torre Pereira', coffee_break_2, 5).
preference('João Torre Pereira', coffee_break_3, 5).
...
preference('João Torre Pereira', escape_room_6, 3).
preference('João Torre Pereira', escape_room_7, 3).
...
preference('João Torre Pereira', workshop_react_next_2, 5).

staff('João Silva', 5, [teaching, github_actions]).
preference('João Silva', coffee_break_1, 0).
preference('João Silva', coffee_break_2, 0).
preference('João Silva', coffee_break_3, 0).
...
preference('João Silva', escape_room_6, 0).
preference('João Silva', escape_room_7, 0).
...
preference('João Silva', workshop_react_next_2, 0).
...
preference('Miguel Garrido', coffee_break_3, 3).
...
preference('Miguel Garrido', escape_room_6, 2).
preference('Miguel Garrido', escape_room_7, 2).
...
preference('Rita Cachaldora', coffee_break_3, 0).
...
preference('Rita Cachaldora', escape_room_6, 0).
preference('Rita Cachaldora', escape_room_7, 0).
...
preference('Eduarda Magno', escape_room_6, 4).
preference('Eduarda Magno', escape_room_7, 4).
...
staff('Vítor Pires', 2, [next, operations]).
preference('Vítor Pires', coffee_break_1, 4).
preference('Vítor Pires', coffee_break_2, 4).
preference('Vítor Pires', coffee_break_3, 4).
preference('Vítor Pires', escape_room_1, 4).
preference('Vítor Pires', escape_room_2, 4).
preference('Vítor Pires', escape_room_3, 4).
preference('Vítor Pires', escape_room_4, 4).
preference('Vítor Pires', escape_room_5, 4).
preference('Vítor Pires', escape_room_6, 4).
preference('Vítor Pires', escape_room_7, 4).
preference('Vítor Pires', panel_pi, 0).
preference('Vítor Pires', talk_chess, 5).
preference('Vítor Pires', talk_design_ai, 2).
preference('Vítor Pires', talk_haskell, 2).
preference('Vítor Pires', talk_visual_design, 3).
preference('Vítor Pires', workshop_github_actions, 2).
preference('Vítor Pires', workshop_react_next_1, 1).
preference('Vítor Pires', workshop_react_next_2, 1).
...
preference('André Lima', escape_room_6, 3).
preference('André Lima', escape_room_7, 3).
...
preference('António Santos', escape_room_6, 3).
preference('António Santos', escape_room_7, 3).
...
staff('Luís Sousa', 4, [next, operations, github_actions]).
preference('Luís Sousa', coffee_break_1, 2).
preference('Luís Sousa', coffee_break_2, 2).
preference('Luís Sousa', coffee_break_3, 2).
...
preference('Luís Sousa', escape_room_6, 1).
preference('Luís Sousa', escape_room_7, 1).
...
preference('Luís Sousa', workshop_react_next_2, 4).

staff('Clara', 1, [react, next, teaching, program, operations, github_actions]).
preference('Clara', coffee_break_1, 5).
preference('Clara', coffee_break_2, 5).
...
preference('Clara', escape_room_6, 1).
preference('Clara', escape_room_7, 1).
...
staff('Tomás Ramos', 2, [react, program, operations]).
preference('Tomás Ramos', coffee_break_1, 4).
preference('Tomás Ramos', coffee_break_2, 4).
preference('Tomás Ramos', coffee_break_3, 4).
preference('Tomás Ramos', escape_room_1, 2).
preference('Tomás Ramos', escape_room_2, 2).
preference('Tomás Ramos', escape_room_3, 2).
preference('Tomás Ramos', escape_room_4, 2).
preference('Tomás Ramos', escape_room_5, 2).
preference('Tomás Ramos', escape_room_6, 2).
preference('Tomás Ramos', escape_room_7, 2).
preference('Tomás Ramos', panel_pi, 4).
preference('Tomás Ramos', talk_chess, 2).
preference('Tomás Ramos', talk_design_ai, 3).
preference('Tomás Ramos', talk_haskell, 4).
preference('Tomás Ramos', talk_visual_design, 2).
...
preference('Tomás Figueiredo Marques Palma', coffee_break_3, 2).
preference('Tomás Figueiredo Marques Palma', escape_room_1, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_2, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_3, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_4, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_5, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_6, 1).
preference('Tomás Figueiredo Marques Palma', escape_room_7, 1).
preference('Tomás Figueiredo Marques Palma', panel_pi, 1).
preference('Tomás Figueiredo Marques Palma', talk_chess, 2).
preference('Tomás Figueiredo Marques Palma', talk_design_ai, 3).
preference('Tomás Figueiredo Marques Palma', talk_haskell, 0).
preference('Tomás Figueiredo Marques Palma', talk_visual_design, 4).
preference('Tomás Figueiredo Marques Palma', workshop_github_actions, 3).
preference('Tomás Figueiredo Marques Palma', workshop_react_next_1, 0).
preference('Tomás Figueiredo Marques Palma', workshop_react_next_2, 0).

staff('Nery', 2, [react, program]).
preference('Nery', coffee_break_1, 4).
preference('Nery', coffee_break_2, 4).
preference('Nery', coffee_break_3, 4).
...
preference('Nery', escape_room_6, 2).
preference('Nery', escape_room_7, 2).
...
staff('Solange', 3, [react, next, operations, github_actions]).
preference('Solange', coffee_break_1, 3).
preference('Solange', coffee_break_2, 3).
preference('Solange', coffee_break_3, 3).
preference('Solange', escape_room_1, 1).
preference('Solange', escape_room_2, 1).
preference('Solange', escape_room_3, 1).
preference('Solange', escape_room_4, 1).
preference('Solange', escape_room_5, 1).
preference('Solange', escape_room_6, 1).
preference('Solange', escape_room_7, 1).
preference('Solange', panel_pi, 1).
preference('Solange', talk_chess, 0).
preference('Solange', talk_design_ai, 2).
preference('Solange', talk_haskell, 1).
preference('Solange', talk_visual_design, 2).
preference('Solange', workshop_github_actions, 3).
preference('Solange', workshop_react_next_1, 1).
preference('Solange', workshop_react_next_2, 1).

staff('Marco Vilas Boas', 2, [teaching]).
preference('Marco Vilas Boas', coffee_break_1, 1).
preference('Marco Vilas Boas', coffee_break_2, 1).
preference('Marco Vilas Boas', coffee_break_3, 1).
...
preference('Marco Vilas Boas', escape_room_6, 2).
preference('Marco Vilas Boas', escape_room_7, 2).
...
preference('Marco Vilas Boas', workshop_react_next_2, 3).

staff('Goiana', 3, [react, next, teaching, program, operations, github_actions]).
preference('Goiana', coffee_break_1, 5).
preference('Goiana', coffee_break_2, 5).
...
preference('Goiana', escape_room_6, 3).
preference('Goiana', escape_room_7, 3).
...
preference('Diogo Fernandes', coffee_break_1, 0).
preference('Diogo Fernandes', coffee_break_2, 0).
...
preference('Diogo Fernandes', escape_room_6, 0).
preference('Diogo Fernandes', escape_room_7, 0).
...
preference('Rui Silveira', coffee_break_3, 5).
...
preference('Rui Silveira', escape_room_6, 5).
preference('Rui Silveira', escape_room_7, 5).
...
preference('Pedro Vidal', coffee_break_3, 3).
...
preference('Pedro Vidal', escape_room_6, 4).
preference('Pedro Vidal', escape_room_7, 4).
...
staff('Martim Moniz', 2, [react, operations]).
...
preference('Martim Moniz', escape_room_6, 1).
preference('Martim Moniz', escape_room_7, 1).
