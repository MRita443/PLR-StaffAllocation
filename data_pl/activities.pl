...
activity(escape_room_2, 2, 71, 3, [program]).
activity(talk_visual_design, 1, 154, 4, [program]).
activity(panel_pi, 1, 164, 4, [program]).
activity(talk_haskell, 1, 168, 2, [program]).
activity(escape_room_3, 2, 151, 3, [program]).
activity(escape_room_4, 2, 154, 3, [program]).
activity(escape_room_5, 2, 157, 3, [program]).
